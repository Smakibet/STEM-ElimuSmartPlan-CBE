...
import { User, AppraisalSession } from '../scripts/types';
                        ...
                        <tr key={i} className="hover:bg-slate-50">
                          ...
                          <td className="p-3">
                            <select
                              ...
                              className={`text-xs border-0 bg-transparent font-bold cursor-pointer focus:ring-0 ${p.status === 'Completed' ? 'text-green-600' :
